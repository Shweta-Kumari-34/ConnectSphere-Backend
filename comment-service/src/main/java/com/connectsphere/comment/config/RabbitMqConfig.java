 ...
 * <p>
 * This configuration defines the necessary beans for the Comment Service to produce
 * asynchronous events (such as notifications) to RabbitMQ. It sets up the {@link RabbitTemplate}
 ...
 * <pre class="mermaid">
 * graph LR;
 *     A[CommentService] -->|Creates Event| B(RabbitTemplate);
